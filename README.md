...
- Prospection client terrain et digitale
- Présentation de solutions adaptées aux besoins métiers des clients
- Analyse des indicateurs de performance commerciale
- Contribution à la stratégie de croissance et à la veille concurrentielle
...
- Gestion du backlog et priorisation des tâches via Jira
- Conception et développement d'applications web Full Stack (Angular / Spring Boot)
- Mise en place d'un compte de mobilité intelligent pour la gestion centralisée de services de transport
- Développement d'un outil KPI Review pour le suivi interactif des performances (équipes, projets, départements)
- Création de dashboards dynamiques, filtres avancés et gestion des rôles utilisateurs
- Implémentation de tests fonctionnels, assurance qualité et rédaction de documentation technique

> **Stack :** `Angular` `Java` `Spring Boot` `PostgreSQL` `Maven` `GitLab` `GitHub` `Jira` `Confluence` `OpenShift` `Liquibase` `Nginx`
...
| 2017 – 2021 | Licence – Développement et Administration d'Applications | Université Alioune Diop de Bambey (UADB) | 🇸🇳 Bambey, Diourbel |
| 2017 | Baccalauréat Scientifique (S2) | Lycée de Ndioum | 🇸🇳 Sénégal |

---

## 🏅 Certifications

- 🏛️ **Database Design** — Oracle Academy
- 🏛️ **Database Foundations** — Oracle Academy
- 🏛️ **Database Programming with SQL** — Oracle Academy
- ☕ **Java Fundamentals & Java Foundations** — Oracle Academy
...
<div align="center">
https://github-readme-stats.vercel.app/api?username=aliou9sow6&token=SHA256:zhPSTQSHwrk31J+fTlTM3TpU4mwGBwEN0Wg34Eshuos
...
|--------|--------|
| 🇫🇷 Français | Courant |
| 🗣️ Pulaar | Langue maternelle |
| 🗣️ Wolof | Courant |
| 🇬🇧 Anglais | Intermédiaire |

---

## 🤝 Vie Associative & Engagement

- 🎓 **Ancien Président** — Amicale des Étudiants du Département de Podor (UADB)
- 🎓 **Ancien Président** — Fédération des Élèves et Étudiants Wodabé (FEEW)
- 📚 **Ancien Président** — Commission Pédagogique (FEEW)
- 📢 **Ancien Chargé de l'Information et de la Communication** — Club DAFI

---

## 💡 Centres d'Intérêt

🏃 Jogging &nbsp;·&nbsp; 📚 Lecture &nbsp;·&nbsp; 🤝 Service communautaire &nbsp;·&nbsp; 💻 Technologies
...
N'hésitez pas à me contacter pour des collaborations ou simplement pour échanger sur les technologies et les projets passionnants. 🚀

📧 [aliou6sow9@gmail.com](mailto:aliou6sow9@gmail.com) &nbsp;|&nbsp; 🔗 [LinkedIn](https://www.linkedin.com/in/aliou-saidou-nourou-sow-054084228/) &nbsp;|&nbsp; 📞 +221 77 050 24 86
